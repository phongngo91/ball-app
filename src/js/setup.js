...
const soccerFieldTexture = new THREE.TextureLoader().load("src/images/soccer_field.png");
const soccerFieldGeometry = new THREE.PlaneGeometry(40, 80, 32);
const soccerFieldMaterial = new THREE.MeshBasicMaterial({ map: soccerFieldTexture });
